...
export default function EventDrawer({ onOpenChange, isOpen, onOpen }: { onOpenChange?: (isOpen: boolean) => void, isOpen?: boolean, onOpen?: () => void }) {

    return (
        <>
            <div className="flex items-center justify-center mr-3" onClick={onOpen}>
                <CalendarDateRangeIcon width={28} height={28} />
            </div>
            <Drawer
                hideCloseButton
                backdrop="blur"
